...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=" + MVCComandKeys.TAREFA_CONCLUIR
        },
        service = MVCActionCommand.class
)
public class ProcessConclusionTarefa extends BaseMVCActionCommand {

    private static final Logger logger = LoggerFactory.getLogger(ProcessConclusionTarefa.class);
    ...
    protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        ...
        try {
            ...
            logger.debug("Seta status concluido nos filhos");
    ...
    private void concluiFilhos(Tarefa tarefa) {
        try {
            ...
            tarefas.forEach(e -> {
                e.setStatus(TarefaStatus.CONCLUIDO.getCodigo());
