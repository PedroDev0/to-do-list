...
public class MVCComandKeys {
    ...
    public static final String TAREFA_FORM = "/tarefas/render/form";
    public static final String TAREFA_VIEW = "/tarefas/render/view";
    ...
    public static final String TAREFA_SUB_INCLUIR_OU_ATUALIZAR = "/tarefas/sub/action/incluir/ou/atualizar";
    public static final String TAREFA_SUB_LISTAR = "/tarefas/render/sub/listar";
