...
public class ToolBarSubTarefaDisplay extends BaseManagementToolbarDisplayContext {

    private final PortalPreferences _portalPreferences;
    private final ThemeDisplay _themeDisplay;

    public ToolBarSubTarefaDisplay(LiferayPortletRequest liferayPortletRequest,
    ...
    public CreationMenu getCreationMenu() {
        ...
        long tarefaId = ParamUtil.getLong(request, "tarefaId");
        // Create the menu.
                ...
                addDropdownItem(
                        dropdownItem -> {
                            dropdownItem.setHref(
                                    ...
                                    "mvcRenderCommandName", MVCComandKeys.TAREFA_SUB_FORM, // trocar para o formulario de cadastro
                                    "tarefaId", tarefaId ,
                                    "redirect", currentURLObj.toString());
                            dropdownItem.setLabel(LanguageUtil.get(request, "add-sub-tarefa"));
                        }
                );
            }
        };
    ...
    public String getSearchActionURL() {
        ...
        searchURL.getRenderParameters().setValue("mvcRenderCommandName", MVCComandKeys.TAREFA_SUB_LISTAR);
        long tarefaId = ParamUtil.getLong(request, "tarefaId");
        searchURL.getRenderParameters().setValue("tarefaId", tarefaId + "");
    ...
    public List<ViewTypeItem> getViewTypeItems() {
        ...
        portletURL.getRenderParameters().setValue("mvcRenderCommandName", MVCComandKeys.TAREFA_SUB_LISTAR);

        long tarefaId = ParamUtil.getLong(request, "tarefaId");
        portletURL.getRenderParameters().setValue("tarefaId", tarefaId + "");
    ...
    private PortletURL _getCurrentSortingURL() throws PortletException {
        ...
        sortingURL.getRenderParameters().setValue("mvcRenderCommandName", MVCComandKeys.TAREFA_SUB_LISTAR);

        long tarefaId = ParamUtil.getLong(request, "tarefaId");
        sortingURL.getRenderParameters().setValue("tarefaId", tarefaId + "");
        // Reset current page.
